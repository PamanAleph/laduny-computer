...
const Footer = () => {
  return (
    <footer className="w-full py-8 dark:bg-gray-950 dark:text-gray-50 border-t-2">
      <div className="w-5/6 flex flex-col px-2 mx-auto lg:flex-row dark:divide-gray-400 border-b border-gray-500 py-2">
      ...
      <div className="flex items-center justify-center px-6 pt-4 text-sm">
